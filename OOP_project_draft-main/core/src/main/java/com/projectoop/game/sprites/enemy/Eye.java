...
public class Eye extends Enemy{
    public enum State {HURTING, ATTACKING, DEAD, FLIGHTING};
    ...
    // test
    private EyeHealthBar healthBar;
    ...
    public Eye(PlayScreen screen, float x, float y) {
        ...
        healthBar = new EyeHealthBar(this, maxHealth);
    }


    protected void prepareAnimation(){
        atlasFlighting = new TextureAtlas("E_FlyingEye/Pack/Flight.pack");
        ...
        flightAnimation = new Animation<TextureRegion>(0.3f, atlasFlighting.getRegions());
...
//        shape.setRadius(9/GameWorld.PPM);
        ...
        //type bit
        fdef.filter.categoryBits = GameWorld.ENEMY1_BIT;
        //Collision bit list
        fdef.filter.maskBits = GameWorld.GROUND_BIT |
            GameWorld.TRAP_BIT | GameWorld.ENEMY1_BIT | GameWorld.CHEST_BIT |
            GameWorld.PILAR_BIT | GameWorld.KNIGHT_BIT | GameWorld.ARROW_BIT| GameWorld.OBJECT_BIT| GameWorld.ENEMY2_BIT|GameWorld.ENEMY_BIT;
        fdef.shape = shape;
    ...
    public TextureRegion getFrame(float dt){
        ...
        switch (currentState){
            ...
            case FLIGHTING:
            default:
                frame = flightAnimation.getKeyFrame(stateTime, true);
