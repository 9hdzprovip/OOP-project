...
public class EyeHealthBar {
    ...
    public EyeHealthBar(Eye eye, float maxHealth) {
        this.eye = eye;
    ...
    public void draw(Batch batch) {
        ...
        float barX = eye.getX()+82/GameWorld.PPM;
        float barY = eye.getY() + eye.getHeight() / 2 + barHeight+ 20/ GameWorld.PPM;
